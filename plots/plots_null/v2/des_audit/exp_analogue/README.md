...
Catalog: `catalog/DES_y1_morph_exp_analogue.csv`

| Metric | Value |
|--------|-------|
| Rows (finite mag + b/a) | 232,191 |
| RA span | 0.000 … 359.999 |
| Dec span | -66.731 … 2.505 |
| median mag | 22.687 |
| median b/a | 0.6997 |
| mean b/a | 0.6699 |
...
```bash
python scripts/audit_des_hsc_mag_ba.py --survey des --exp-analogue
```
