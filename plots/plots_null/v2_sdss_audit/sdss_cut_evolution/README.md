...
Catalog: `SDSS_catalog_v2_fullsky_modelmr.csv` (HTM random, full footprint).
...
python scripts/plot_sdss_null_cut_evolution_cdfs.py \
  --sdss-csv SDSS_catalog_v2_fullsky_modelmr.csv \
  --out-dir plots/plots_null/v2_sdss_audit/sdss_cut_evolution \
